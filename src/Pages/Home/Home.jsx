...
const Home = () => {
  return (
    <div id='hero' className='relative flex flex-col items-center justify-center py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center bg-gradient-to-b from-blue-50 to-white dark:from-gray-800 dark:to-gray-900'>
      ...
      <h1 className='text-4xl sm:text-5xl md:text-6xl xl:text-[84px] font-medium xl:leading-[95px] max-w-5xl text-gray-600 dark:text-gray-300 '>
        Tuning imagination into <span className='bg-gradient-to-r from-[#5044e5] to-[#4d8cea] bg-clip-text text-transparent'>digital</span> impact.
      </h1>
      
      <p className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 max-w-4/5 sm:maxw-lg- pb-3'>
